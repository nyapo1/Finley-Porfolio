      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-4 my-3 text-center">
            <h5>Contact</h5>
            <p><FaEnvelope/> Email: <a href="mailto:finleyche051@gmail.com" className="text-light">finleyche051@gmail.com</a></p>
          </div>
        </div>
        <hr className="text-light" />
        <div className="text-center">
          <p>&copy; {new Date().getFullYear()} Finley Che. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
